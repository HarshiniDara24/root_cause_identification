...
password = os.environ['PASSWORD'] # safely encode special characters in password
db_name = os.environ['DB_NAME']


mongo_client = MongoClient(
    f"mongodb+srv://{username}:{password}@cluster0.1vrauac.mongodb.net/{db_name}?retryWrites=true&w=majority&appName=Cluster0"
)
